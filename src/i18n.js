...
window.FLOBRO_I18N = (function () {
  const dict = {
    en: {
      ...
      share_usage_sub:
        'Only the hostname of floated pages (like github.com). Never full URLs, never your IP.',
      language: 'Language',
    ...
    nl: {
      ...
      share_usage_sub:
        'Alleen de hostnaam van gefloate pagina’s (zoals github.com). Nooit volledige URL’s, nooit je IP.',
      language: 'Taal',
      ...
      up_to_date: 'Je gebruikt de nieuwste versie.',
